...
CATEGORY_RULES: dict[str, list[str]] = {
    "club_activity": ["活动", "社团", "讲堂", "沙龙", "训练营", "校园文化", "晚会", "展演", "工作坊"],
    "lecture": ["讲座", "论坛", "报告", "宣讲", "学术", "分享会", "研讨", "公开课"],
    "volunteer": ["志愿", "义工", "公益", "志愿者", "服务日", "服务队"],
    "competition": ["竞赛", "比赛", "挑战赛", "大赛", "评比", "征集", "作品赛"],
    "exam": ["考试", "考核", "报名", "四六级", "选课", "缓考", "补考", "机考"],
    "recruitment": ["招聘", "招募", "实习", "春招", "秋招", "纳新", "遴选", "投递"],
